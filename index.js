...
async function deploy(w) {
  ...
  let contractinfo = JSON.parse(fs.readFileSync('./artifacts/ETCOdyssey.json'))
  ...
  console.log(`Deploying ETC Odyssey (${contract.address}) to ETC mainnet; tx ${contract.deployTransaction.hash}`)
